...
<<<<<<< HEAD:plugins/com.cod.cordova.bluetoothhealth/src/android/com/cod/cordova/BluetoothSerial.java
/**
...
>>>>>>> c416329a3256c92f7532516a67eb3ad1d22ce0f1:plugins/com.cod.cordova.bluetoothhealth/src/android/com/cod/cordova/HDPBluetoothSerial.java
    ...
    private Handler mIncomingHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case BluetoothHDPService.STATUS_HEALTH_APP_REG:
                // notify user
                Log.d(TAG, "Health Service app registered.");
                break;
            // Application unregistration complete.
            case BluetoothHDPService.STATUS_HEALTH_APP_UNREG:
                // notify user
                Log.d(TAG, "Health Service app unregistered.");
                break;
            // Reading data from HDP device.
            case BluetoothHDPService.STATUS_READ_DATA:
                // get data passing to analyzer
                // notify user
                Log.d(TAG, "Health Service is reading data.");
                break;
            // Finish reading data from HDP device.
            case BluetoothHDPService.STATUS_READ_DATA_DONE:

                bp = (numericBP) msg.obj;
                Log.d(TAG, "Health Service finished reading data." + "sys= "
                        + bp.Systolic + "\n" + "dia=" + bp.Diastolic + "\n"
                        + "MAP=" + bp.MAP + "\n" + "pusle= " + bp.pulse + "\n"
                        + bp.time);
                JSONObject json = new JSONObject();
                try{
                    json.put("sys", bp.Systolic);
                    json.put("dia", bp.Diastolic);
                    json.put("pulse", bp.pulse);
                    json.put("time", bp.time);
                }catch (JSONException e){
                    Log.w(TAG, "Final data's JSON Parsing error.");
                }

                connectCallback.success(json);
            ...
            case BluetoothHDPService.STATUS_CREATE_CHANNEL:
                ...
                Log.d(TAG, "Health Service create channel. Namely, connected.");
                break;
            ...
            case BluetoothHDPService.STATUS_DESTROY_CHANNEL:
                ...
                // if it's failed, handle it
                Log.d(TAG,
                        "Health Service destoryed channel.. Namely, disconnected");
                break;
            default:
